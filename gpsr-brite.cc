...
NS_LOG_COMPONENT_DEFINE ("gpsr-testing");
...
uint32_t LostPackets = 0;
  ...
  std::string confFile = "scratch/TD_ASBarabasi_RTWaxman_50.conf";
  ...
  NS_LOG_INFO ("-----------Nodes  "<< bth.GetNNodesTopology());

  NodeContainer adhocNodes;
  adhocNodes.Create (bth.GetNNodesTopology());
  ...
  pos.Set ("X", StringValue ("ns3::UniformRandomVariable[Min=0.0|Max=900.0]"));
  ...
  bth.AssignIpv4Addresses (addressAdhoc);
...
//anim
AnimationInterface anim("gpsr-animacija");
...
monitor->SerializeToXmlFile("GPSR-novo-novo-60.xml", true, true);
